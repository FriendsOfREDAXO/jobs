...
class LangHelper extends \TobiasKrais\D2UHelper\ALangHelper
{
    ...
    protected $replacements_chinese = [
        ...
        'jobs_module_attachment_delete_file_msg' => '确定删除附件吗？',
        'jobs_module_attachment_empty_error_msg' => '请上传文件。',
        'jobs_module_attachment_max_error_msg' => '文件大小超过限制。',
        'jobs_module_attachment_min_error_msg' => '上传的文件太小或没有内容。',
        'jobs_module_attachment_system_error_msg' => '系统错误。',
        'jobs_module_attachment_type_error_msg' => '文件类型不允许。',
        ...
        'jobs_salary_unit_HOUR' => '小时',
        'jobs_salary_unit_MONTH' => '月',
        'jobs_salary_unit_YEAR' => '年',
        'jobs_work_hours' => '每周工时',
        'jobs_vacancies' => '招聘岗位',
    ...
    protected array $replacements_dutch = [
        ...
        'jobs_module_attachment_delete_file_msg' => 'Weet u zeker dat u het bijgevoegde bestand wilt verwijderen?',
        'jobs_module_attachment_empty_error_msg' => 'Upload een bestand.',
        'jobs_module_attachment_max_error_msg' => 'Maximale bestandsgrootte overschreden.',
        'jobs_module_attachment_min_error_msg' => 'Het geüploade bestand is te klein of bevat geen inhoud.',
        'jobs_module_attachment_system_error_msg' => 'Systeemfout.',
        'jobs_module_attachment_type_error_msg' => 'Bestandstype niet toegestaan.',
        ...
        'jobs_salary_unit_HOUR' => 'Uur',
        'jobs_salary_unit_MONTH' => 'Maand',
        'jobs_salary_unit_YEAR' => 'Jaar',
        'jobs_work_hours' => 'Werkuren per week',
    ...
    public $replacements_english = [
        ...
        'jobs_module_attachment_delete_file_msg' => 'Delete attached file?',
        'jobs_module_attachment_empty_error_msg' => 'Please upload a file.',
        'jobs_module_attachment_max_error_msg' => 'Maximum file size exceeded.',
        'jobs_module_attachment_min_error_msg' => 'The uploaded file is too small or has no content.',
        'jobs_module_attachment_system_error_msg' => 'System error.',
        'jobs_module_attachment_type_error_msg' => 'File type not allowed.',
        ...
        'jobs_salary_unit_HOUR' => 'Hour',
        'jobs_salary_unit_MONTH' => 'Month',
        'jobs_salary_unit_YEAR' => 'Year',
        'jobs_work_hours' => 'Weekly hours',
    ...
    protected array $replacements_french = [
        ...
        'jobs_module_attachment_delete_file_msg' => 'Voulez-vous vraiment supprimer le fichier joint?',
        'jobs_module_attachment_empty_error_msg' => 'Veuillez télécharger un fichier.',
        'jobs_module_attachment_max_error_msg' => 'Taille de fichier maximale dépassée.',
        'jobs_module_attachment_min_error_msg' => 'Le fichier téléchargé est trop petit ou ne contient aucun contenu.',
        'jobs_module_attachment_system_error_msg' => 'Erreur système.',
        'jobs_module_attachment_type_error_msg' => 'Type de fichier non autorisé.',
        ...
        'jobs_salary_unit_HOUR' => 'Heure',
        'jobs_salary_unit_MONTH' => 'Mois',
        'jobs_salary_unit_YEAR' => 'An',
        'jobs_work_hours' => 'Heures par semaine',
    ...
    protected array $replacements_german = [
        ...
        'jobs_module_attachment_delete_file_msg' => 'Angehängte Datei wirklich löschen?',
        'jobs_module_attachment_empty_error_msg' => 'Bitte Datei hochladen.',
        'jobs_module_attachment_max_error_msg' => 'Maximale Dateigröße überschritten.',
        'jobs_module_attachment_min_error_msg' => 'Die hochgeladene Datei ist zu klein oder hat gar keinen Inhalt.',
        'jobs_module_attachment_system_error_msg' => 'Systemfehler.',
        ...
        'jobs_salary_unit_HOUR' => 'Stunde',
        'jobs_salary_unit_MONTH' => 'Monat',
        'jobs_salary_unit_YEAR' => 'Jahr',
        'jobs_work_hours' => 'Wochenarbeitszeit',
    ...
    protected array $replacements_spanish = [
        ...
        'jobs_module_attachment_delete_file_msg' => '¿Seguro que quieres eliminar el archivo adjunto?',
        'jobs_module_attachment_empty_error_msg' => 'Por favor, sube un archivo.',
        'jobs_module_attachment_max_error_msg' => 'Tamaño de archivo máximo excedido.',
        'jobs_module_attachment_min_error_msg' => 'El archivo subido es demasiado pequeño o no tiene contenido.',
        'jobs_module_attachment_system_error_msg' => 'Error del sistema.',
        'jobs_module_attachment_type_error_msg' => 'Tipo de archivo no permitido.',
        ...
        'jobs_salary_unit_HOUR' => 'Hora',
        'jobs_salary_unit_MONTH' => 'Mes',
    ...
    protected array $replacements_russian = [
        ...
        'jobs_module_attachment_delete_file_msg' => 'Удалить прикрепленный файл?',
        'jobs_module_attachment_empty_error_msg' => 'Пожалуйста, загрузите файл.',
        'jobs_module_attachment_max_error_msg' => 'Превышен максимальный размер файла.',
        'jobs_module_attachment_min_error_msg' => 'Загруженный файл слишком мал или не содержит содержимого.',
        'jobs_module_attachment_system_error_msg' => 'Системная ошибка.',
        'jobs_module_attachment_type_error_msg' => 'Тип файла не разрешен.',
        ...
        'jobs_region' => 'город',
        'jobs_salary' => 'зарплата',
        'jobs_salary_max' => 'Максимальная зарплата',
        'jobs_salary_unit_HOUR' => 'Час',
        'jobs_salary_unit_MONTH' => 'Месяц',
        'jobs_salary_unit_YEAR' => 'Год',
        'jobs_work_hours' => 'Часы в неделю',
